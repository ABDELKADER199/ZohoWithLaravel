...
<div class="container">
    <h2 class="mb-4 fw-bold text-center text-primary">📱 Zoho Leads</h2>
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-header bg-primary text-white fw-bold">Create New Leads</div>
        <div class="card-body">
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-secondary text-white fw-bold">Leads List</div>
            ...
            <table class="table table-striped mb-0">
                ...
                @forelse($leads as $c)
                    <tr>
                        ...
                        <td>{{ $c['phone'] ?? '' }}</td>
                        <td>
                            <a href="{{ route('leads.edit', $c['id']) }}" class="btn btn-sm btn-outline-primary">Edit</a>
                            <form class="d-inline" action="{{ route('leads.destroy', $c['id']) }}" method="POST" onsubmit="return confirm('Delete this lead?')">
                                @csrf
                                @method('DELETE')
